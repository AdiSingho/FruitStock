...
<div class="flex h-screen overflow-hidden bg-fruit-bg">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-8 shrink-0">
            <!-- Search Bar -->
            <div class="w-1/2 max-w-lg relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
                <input type="text" class="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-transparent rounded-xl focus:bg-white focus:border-fruit-green focus:ring-2 focus:ring-fruit-green-light text-sm transition-all" placeholder="Cari buah, stok...">
            </div>
